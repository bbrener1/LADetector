...
GENOME=~/Documents/scripts/LADetector_scripts/hg19.genome 
UNALIGNABLE=~/Documents/scripts/LADetector_scripts/hg19.unalignable.bed
...
bedtools intersect -a $1 -b $unalignable.complement -u > $prefix.LADs
